...
function check_device_make_tr(data) {
    ...
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        ...
        table_str += '<th role="columnheader">Chat</th>';
        ...
        while (index_of_response < data.length) {
            ...
            tbody += '></td><td role="cell"><input id="privilege_for_chat' + data[index_of_response]['user_id'] + '" class="w3-check" type="checkbox" ';
            data[index_of_response]['privilege_for_chat'] == 1 ? tbody += 'checked="checked" ' : tbody += ' ';
        ...
        table_str += '<th class="w3-center">Chat</th>';
        ...
        while (index_of_response < data.length) {
            ...
            data[index_of_response]['privilege_for_view_and_edit_created_user'] == 1 ? tbody += 'checked="checked" ' : tbody += ' ';
            tbody += '></td><td class="w3-center"><input id="privilege_for_chat' + data[index_of_response]['user_id'] + '" class="w3-check" type="checkbox" ';
            data[index_of_response]['privilege_for_chat'] == 1 ? tbody += 'checked="checked" ' : tbody += ' ';
...
function save_changed_privilege_record(id) {
    ...
    let privilege_for_chat = document.getElementById("privilege_for_chat" + id).checked;
    privilege_for_chat == true ? privilege_for_chat = 1 : privilege_for_chat = 0;
    ...
    $.ajax({
        ...
        data: {
            ...
            privilege_for_chat: privilege_for_chat,
