...
<body>
    ...
    ?>
        ...
        <div class="w3-container w3-bar">
            ...
            <button onclick="get_privilege_data()" class="w3-xlarge w3-bar-item w3-margin-top w3-right w3-button" title="Refresh or Get"><i class="fa fa-refresh" aria-hidden="true"></i></i></button>
        </div>
