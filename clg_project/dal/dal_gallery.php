...
if (isset($_FILES['file']['name']) and $_FILES['file']['size'] > 0 and isset($_POST['project_id'])) {
    ...
    if (move_uploaded_file($fileTmpName, $fileDestination)) {
        ...
        mysqli_query($con, "CALL project_management_system_sp_of_gallery_details('$fileName','$fileNameNew','$fileDestinationForUpload',$_POST[project_id],$_SESSION[user_id],CURRENT_TIMESTAMP,1,@out_parameter)");
