...
if (isset($_POST['ask_entered_question'])) {
       $date = date("Y-m-d h:i:s");
       $ask_question = "INSERT INTO tbl_faq( faq, faq_ans, faq_ans_status, user_id, faq_added_date_time) VALUES ('$_POST[question]','',0,$_SESSION[user_id],'$date')";
       if (mysqli_query($con, $ask_question)) {
              echo "1";
       }
       exit();
}
