...
if (isset($_POST['save_do_it_content_to_tbl'])) {
       try {
              ...
              mysqli_query($con, "CALL sp_content($_SESSION[user_id],0,'$_POST[do_it_content]',1,$_POST[project_id],1,@out_parameter)");
...
if (isset($_POST['move_content'])) {
       try {
              mysqli_query($con, "set @out_parameter=0");
              mysqli_query($con, "CALL sp_content($_SESSION[user_id],$_POST[content_id],'',$_POST[id],$_POST[project_id],2,@out_parameter)");
              $rs2 = mysqli_query($con, "SELECT @out_parameter as out_parameter ");
              $row = mysqli_fetch_assoc($rs2);
