...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2023 at 07:54 PM
...
-- mode 2
	IF(p_mode = 2) THEN
		...
		SELECT IFNULL((SELECT @temp_userid := user_id FROM tbl_user WHERE user_email_add = p_useremail AND user_password = p_userpassword), @temp_userid := 0);
