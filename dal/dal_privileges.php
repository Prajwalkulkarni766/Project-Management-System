...
if (isset($_POST['save_changed_privilege'])) {
    ...
    mysqli_query($con, "CALL project_management_sp_for_privileges(@p_privilegeid,$_POST[privilege_for_view_dashboard],$_POST[privilege_for_move_dashboard_content],$_POST[privilege_for_view_project],$_POST[privilege_for_add_new_project],$_POST[privilege_for_edit_project],$_POST[privilege_for_view_reports],$_POST[privilege_to_change_privilege],$_POST[privilege_for_create_user],$_POST[privilege_for_view_and_edit_created_user],$_POST[privilege_for_chat],$_POST[privilege_for_upload_images],$_POST[privilege_for_delete_uploaded_images],$_POST[privilege_for_upload_documents],$_POST[privilege_for_delete_uploaded_documents],$_POST[id],$_SESSION[user_id],CURRENT_TIMESTAMP,6)");
